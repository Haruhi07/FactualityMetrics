...
python3 -u marker.py --summary results/epoch_0/predictions.json --reference results/references.json --source results/source.json --rouge --factcc --output 0epoch.json
...
python3 -u marker.py --summary results/random/predictions.json --reference results/references.json --source results/source.json --rouge --factcc --output random.json